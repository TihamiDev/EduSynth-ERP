                                ...
                                <div class="col-12">
                                    <div class="card my-3">
                                                                    ...
                                                                    {{-- <div class="accordion-item"> --}}
                                                                        ...
                                                                        {{-- <div id="accordionClass{{$school_class->id}}Section{{$school_section->id}}" class="accordion-collapse collapse" aria-labelledby="headingClass{{$school_class->id}}Section{{$school_section->id}}" data-bs-parent="#accordionClass{{$school_class->id}}"> --}}
                                                                            <div class="room-section">
                                                                                <p class="lead d-flex justify-content-between mx-3 mb-0">
                                                                                    <span class="fw-bold">Room No: {{$school_section->room_no}}</span>
                                                                                </p>
                                                                                <div class="link-group">
                                                                                    <a href="{{route('student.list.show', ['class_id' => $school_class->id, 'section_id' => $school_section->id, 'section_name' => $school_section->section_name])}}" class="btn btn-subtle mx-1 my-1">
                                                                                        View Students <i class="bi bi-arrow-right"></i>
                                                                                    </a>
                                                                                    <a href="{{route('section.routine.show', ['class_id' => $school_class->id, 'section_id' => $school_section->id])}}" class="btn btn-subtle mx-1 my-1">
                                                                                        View Routine <i class="bi bi-arrow-right"></i>
                                                                                    </a>
                                                                                    @can('edit sections')
                                                                                    <a href="{{route('section.edit', ['id' => $school_section->id])}}" role="button" class="btn btn-subtle mx-1 my-1">
                                                                                        <i class="bi bi-pencil"></i> Edit <i class="bi bi-arrow-right"></i>
                                                                                    </a>
                                                                                    @endcan
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @foreach ($school_class->syllabi as $syllabus)
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{asset('storage/'.$syllabus->syllabus_file_path)}}" role="button" class="btn btn-primary"><i class="bi bi-download"></i> Download</a>
                                                                </div>
                                                            </td>
                                                            </tr>
                                                        @endforeach
                                                    ...
                                                    @isset($school_class->courses)
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @can('edit courses')
                                                                    <a href="{{route('course.edit', ['id' => $course->id])}}" class="btn btn-subtle" role="button"><i class="bi bi-pencil"></i> Edit <i class="bi bi-arrow-right"></i></a>
                                                                    @endcan
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                        ...
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                            ...
                                            @endisset
                                            @can('edit classes')
                                            <span><a href="{{route('class.edit', ['id' => $school_class->id])}}" class="btn btn-lg btn-primary" role="button"><i class="bi bi-pencil"></i> Edit Class</a></span>
                                            @endcan
                                        </div>
                                    </div>
                                </div>
