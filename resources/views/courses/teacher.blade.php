        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <div class="card-body">
                        <div class="table-data p-1 bg-white border shadow-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="link-group">
                                                    ...
                                                    <a href="{{route('attendance.create.show', [
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-calendar2-week me-2"></i> Take Attendance <i class="bi bi-arrow-right"></i></a></li>
                                                      <li><a href="{{route('attendance.list.show', [
                                                        ...
                                                        'section_name' => $course->section->section_name,
                                                        'course_name' => $course->course->course_name
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-calendar2-week-fill me-2"></i> View Attendance <i class="bi bi-arrow-right"></i></a></li>
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-file-post me-2"></i> Create Assignment <i class="bi bi-arrow-right"></i></a></li>
                                                    ...
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-input-cursor me-2"></i> Give Marks <i class="bi bi-arrow-right"></i></a></li>
                                                    <li><a href="{{route('course.mark.list.show', [
                                                        ...
                                                        'course_name' => $course->course->course_name,
                                                        'semester_id' => $selected_semester_id
                                                    ])}}" role="button" class="dropdown-item"><i class="bi bi-cloud-sun me-2"></i> View Final Results <i class="bi bi-arrow-right"></i></a></li>
                                                    <li><a href="#" role="button" class="dropdown-item disabled"  tabindex="-1" aria-disabled="true"><i class="bi bi-chat-left-text me-2"></i> Message Students <i class="bi bi-arrow-right"></i></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
