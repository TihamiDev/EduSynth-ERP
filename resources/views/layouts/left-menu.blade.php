<div class="left-menu col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('academics*') ? 'active' : '' }}"
                        href="{{ url('academics/settings') }}"><i class="bi bi-tools"></i> <span
                            class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Settings</span></a>
                </li>
            @endif
            @if (!session()->has('browse_session_id') && Auth::user()->role == 'admin')
                <li class="nav-item">
